...
RipioOrderBookTrackingDictionary = Dict[Decimal, Dict[str, Dict[str, any]]]

cdef class RipioActiveOrderTracker:
    def __init__(self,
                 active_asks: RipioOrderBookTrackingDictionary = None,
                 active_bids: RipioOrderBookTrackingDictionary = None):
        super().__init__()
    ...
    @property
    def active_asks(self) -> RipioOrderBookTrackingDictionary:
        return self._active_asks

    @property
    def active_bids(self) -> RipioOrderBookTrackingDictionary:
